...
function Input() {
  ...
  return (
    <div className={`border-b border-gray-700 p-3 flex space-x-3 overflow-y-scroll 
      ${loading && "opacity-60"}`}
    >
      <img src="https://pbs.twimg.com/profile_images/1405731311914913794/c-40xdgh_400x400.jpg" alt=""
        ...
        {!loading && (
          <div className="flex items-center justify-between pt-2.5">
            ...
            <div className="flex items-center">
              <div className="icon" onClick={() => filePickerRef.current.click() /* clica na div e ativa o input */}>
            ...
            <button
              ...
              disabled={!input.trim() && !selectedFile /*.trim() espaço não conta como caractere*/}
              onClick={sendPost}>
              Tweet
            </button>
