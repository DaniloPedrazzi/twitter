...
function Sidebar() {
  return (
    <div className="hidden sm:flex flex-col items-center xl:items-start xl:w-[340px] p-2 fixed h-full">
      ...
      <button className="hidden xl:inline ml-auto bg-[#1b9bf0] 
      ...
      xl:ml-auto xl:-mr-5 mt-auto ">
        <img 
          src="https://pbs.twimg.com/profile_images/1405731311914913794/c-40xdgh_400x400.jpg"
          alt=""
          className="h-10 w-10 rounded-full xl:mr-2.5" 
        />
        <div className="hidden xl:inline leading-5 ">
          <h4 className="font-bold">Danilin</h4>
          <p className="text-[#6e767b]">@:)))))</p>
        </div>
